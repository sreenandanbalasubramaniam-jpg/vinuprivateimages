...
// Fix: Added explicit React import to resolve 'Cannot find namespace React' error
__turbopack_context__.s([
    "default",
    ()=>RootLayout,
    "metadata",
...
;
const metadata = {
    title: 'GeoConsent Project',
    description: 'Secure identity verification via location sync'
};
